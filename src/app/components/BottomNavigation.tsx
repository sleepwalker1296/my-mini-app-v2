            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center gap-1">
                  <div className={`transition-colors duration-200 ${isActive ? 'text-purple-400' : 'text-zinc-500'}`}>
                    <Icon className="w-5 h-5" />
                  </div>
                  <span className={`text-xs transition-colors duration-200 ${isActive ? 'text-white' : 'text-zinc-500'}`}>
                    {tab.label}
                  </span>
                </div>
              </button>
