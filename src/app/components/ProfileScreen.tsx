...
export function ProfileScreen() {
  return (
    <div className="space-y-6">
          ...
          {services.map((service) => {
            ...
            return (
              <motion.div
                key={service.id}
                whileTap={{ scale: 0.98 }}
                className="bg-gradient-to-br from-zinc-900/80 to-zinc-950/80 rounded-2xl p-4 border border-zinc-800/50 backdrop-blur-xl shadow-xl active:shadow-lg transition-shadow cursor-pointer"
                style={{ willChange: 'transform' }}
              >
                <div className="flex items-start gap-4">
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${service.color} bg-opacity-10 flex items-center justify-center flex-shrink-0`}>
          ...
          {contacts.map((contact) => {
            ...
            return (
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="flex items-center justify-between p-4 bg-gradient-to-br from-zinc-900/80 to-zinc-950/80 rounded-2xl border border-zinc-800/50 backdrop-blur-xl shadow-xl active:shadow-lg transition-shadow"
                style={{ willChange: 'transform' }}
              >
      ...
      {/* CTA */}
      <div className="bg-gradient-to-br from-purple-600/10 to-blue-600/10 rounded-2xl p-6 border border-purple-500/20 backdrop-blur-xl">
        ...
        <motion.a
          ...
          rel="noopener noreferrer"
          whileTap={{ scale: 0.98 }}
          className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 text-white shadow-lg shadow-purple-500/25 active:shadow-purple-500/15 transition-shadow"
          style={{ willChange: 'transform' }}
        >
